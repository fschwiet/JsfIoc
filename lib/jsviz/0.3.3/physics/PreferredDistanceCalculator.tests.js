...
describe("PreferredDistanceCalculator", function () {
    ...
    it("when two RectangleParticles are seperated by more then minimum expected distance horizontally, there is a little pull", function () {
        ...
        expect(sut.GetDistance(left, right, actualDistance)).toEqual(actualDistance * 0.99);
        expect(sut.GetDistance(right, left, actualDistance)).toEqual(actualDistance * 0.99);
    });
    ...
    it("when two RectangleParticles are seperated by more then minimum expected distance vertically, there is a little pull", function () {
        ...
        expect(sut.GetDistance(top, bottom, actualDistance)).toEqual(actualDistance * 0.99);
        expect(sut.GetDistance(bottom, top, actualDistance)).toEqual(actualDistance * 0.99);
    });
