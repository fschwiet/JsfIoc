...
Spring.prototype = {
    ...
    */
    init: function (a, b, springConstant, dampingConstant, restLength) {
        ...
        this['distanceCalculator'] = new PreferredDistanceCalculator(restLength);
    ...
    */
    apply: function () {
        ...
        var preferredDistance = this.distanceCalculator.GetDistance(this.a, this.b, springLength);

        // Determine the spring force
        var springForce = -(springLength - preferredDistance) * this.springConstant;
